...
**[Play all six builds in your browser](https://barty-bart.github.io/opus-55-effort-comparison/)** · [Original prompt](prompts/original.txt) · [Special Build prompt](prompts/special-build.txt)
...
Use the online link above and choose a build. Desktop keyboard and mouse recommended. No login, AI account, API key or paid service is needed to play. These are static HTML/CSS/JavaScript games; no AI calls run during gameplay. Audio activates after a click. Some builds use browser storage for settings/maps; the Special Build also uses browser speech synthesis, whose voices depend on your browser and OS.

To play locally, download **Code → Download ZIP**, extract it, open a terminal in the extracted folder, and run:

```sh
python3 -m http.server 8000 --bind 127.0.0.1
```

On Windows, use `py -m http.server 8000 --bind 127.0.0.1` if needed. Open `http://127.0.0.1:8000` in your browser. This address belongs to your own computer. No npm install or build step is required. Use a web server rather than double-clicking game files because several builds use JavaScript modules.

## Recorded results

| Build | Recorded elapsed time | Total tokens | Estimated token cost |
|---|---:|---:|---:|
| [Low](https://barty-bart.github.io/opus-55-effort-comparison/games/low/) | 19m 10s | 3,140,950 | $3.79 |
| [Medium](https://barty-bart.github.io/opus-55-effort-comparison/games/medium/) | 36m 35s | 11,131,202 | $9.25 |
| [High](https://barty-bart.github.io/opus-55-effort-comparison/games/high/) | 1h 00m 33s | 30,665,190 | $16.11 |
| [X High](https://barty-bart.github.io/opus-55-effort-comparison/games/xhigh/) | 1h 45m 51s | 79,623,100 | $35.26 |
| [Max](https://barty-bart.github.io/opus-55-effort-comparison/games/max/) | 2h 58m 27s | 173,338,200 | $69.14 |
| [Special Build (Low)](https://barty-bart.github.io/opus-55-effort-comparison/games/special/) | 1h 23m 06s | 21,005,436 | $13.57 |
